...
| `EMBED_API_URL`    | No       | Koyeb†  | Origin of YOUR hosted embed/stream API. Used by the Core, AniNico, and VidStream providers. Falls back to a public Koyeb-hosted instance if unset; set this to your own instance (Koyeb / Railway / Render / custom domain) for production traffic. |
